...
public class Game_Controller {
	...
	/*
	 * setController()
	 * Purpose:	Simulate a single game (up to 61 points) of Cribbage.
	 */
	...
	/*
	 * roundController()
	 * Purpose: Simulate a single hand round of Cribbage (from deal to counting hand points)
	 */
	...
	/*
	 * turnController()
	 * Purpose: Simulate a single player's turn in Cribbage, including "go" case.
	 */
